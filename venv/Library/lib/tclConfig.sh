...
# installed.
TCL_PREFIX='C:/PROJECTS/News Script/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/PROJECTS/News Script/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/PROJECTS/News Script/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/PROJECTS/News Script/venv\Library\include'
...
TCL_PACKAGE_PATH='C:/PROJECTS/News Script/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/PROJECTS/News Script/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/PROJECTS/News Script/venv\Library\lib\tclstub86.lib'
